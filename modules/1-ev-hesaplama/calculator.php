...
function hc_render_1_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-1-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/1-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-1-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/1-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-1">
        <h3>1. Ev (Yükselen Burç) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h1-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h1-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h1-time">Doğum Saati:</label>
            <input type="time" id="hc-h1-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h1-city">Şehir (Yaklaşık Konum için):</label>
            <select id="hc-h1-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse1Hesapla()">1. Evi Hesapla</button>
        <div class="hc-result" id="hc-1-ev-hesaplama-result">
            <div class="hc-result-label">1. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h1-val">-</div>
            <div id="hc-res-h1-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
