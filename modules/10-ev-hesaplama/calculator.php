...
function hc_render_10_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-10-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/10-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-10-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/10-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-10">
        <h3>10. Ev (Kariyer ve Statü) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h10-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h10-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h10-time">Doğum Saati:</label>
            <input type="time" id="hc-h10-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h10-city">Şehir:</label>
            <select id="hc-h10-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse10Hesapla()">10. Evi Hesapla</button>
        <div class="hc-result" id="hc-10-ev-hesaplama-result">
            <div class="hc-result-label">10. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h10-val">-</div>
            <div id="hc-res-h10-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
