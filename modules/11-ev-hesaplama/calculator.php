...
function hc_render_11_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-11-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/11-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-11-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/11-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-11">
        <h3>11. Ev (Sosyal Çevre ve Hayaller) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h11-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h11-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h11-time">Doğum Saati:</label>
            <input type="time" id="hc-h11-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h11-city">Şehir:</label>
            <select id="hc-h11-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse11Hesapla()">11. Evi Hesapla</button>
        <div class="hc-result" id="hc-11-ev-hesaplama-result">
            <div class="hc-result-label">11. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h11-val">-</div>
            <div id="hc-res-h11-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
