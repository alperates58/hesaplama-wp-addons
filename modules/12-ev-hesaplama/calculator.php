...
function hc_render_12_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-12-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/12-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-12-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/12-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-12">
        <h3>12. Ev (Bilinçaltı ve Gizli Dünyanız) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h12-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h12-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h12-time">Doğum Saati:</label>
            <input type="time" id="hc-h12-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h12-city">Şehir:</label>
            <select id="hc-h12-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse12Hesapla()">12. Evi Hesapla</button>
        <div class="hc-result" id="hc-12-ev-hesaplama-result">
            <div class="hc-result-label">12. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h12-val">-</div>
            <div id="hc-res-h12-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
