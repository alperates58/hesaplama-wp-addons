...
function hc_render_3_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-3-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/3-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-3-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/3-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-3">
        <h3>3. Ev (İletişim ve Yakın Çevre) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h3-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h3-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h3-time">Doğum Saati:</label>
            <input type="time" id="hc-h3-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h3-city">Şehir:</label>
            <select id="hc-h3-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse3Hesapla()">3. Evi Hesapla</button>
        <div class="hc-result" id="hc-3-ev-hesaplama-result">
            <div class="hc-result-label">3. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h3-val">-</div>
            <div id="hc-res-h3-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
