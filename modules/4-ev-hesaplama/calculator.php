...
function hc_render_4_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-4-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/4-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-4-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/4-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-4">
        <h3>4. Ev (Aile ve Yuva) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h4-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h4-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h4-time">Doğum Saati:</label>
            <input type="time" id="hc-h4-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h4-city">Şehir:</label>
            <select id="hc-h4-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse4Hesapla()">4. Evi Hesapla</button>
        <div class="hc-result" id="hc-4-ev-hesaplama-result">
            <div class="hc-result-label">4. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h4-val">-</div>
            <div id="hc-res-h4-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
