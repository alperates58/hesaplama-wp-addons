...
function hc_render_5_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-5-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/5-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-5-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/5-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-5">
        <h3>5. Ev (Aşk ve Yaratıcılık) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h5-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h5-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h5-time">Doğum Saati:</label>
            <input type="time" id="hc-h5-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h5-city">Şehir:</label>
            <select id="hc-h5-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse5Hesapla()">5. Evi Hesapla</button>
        <div class="hc-result" id="hc-5-ev-hesaplama-result">
            <div class="hc-result-label">5. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h5-val">-</div>
            <div id="hc-res-h5-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
