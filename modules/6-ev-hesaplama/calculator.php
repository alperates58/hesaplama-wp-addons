...
function hc_render_6_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-6-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/6-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-6-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/6-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-6">
        <h3>6. Ev (Sağlık ve Hizmet) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h6-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h6-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h6-time">Doğum Saati:</label>
            <input type="time" id="hc-h6-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h6-city">Şehir:</label>
            <select id="hc-h6-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse6Hesapla()">6. Evi Hesapla</button>
        <div class="hc-result" id="hc-6-ev-hesaplama-result">
            <div class="hc-result-label">6. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h6-val">-</div>
            <div id="hc-res-h6-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
