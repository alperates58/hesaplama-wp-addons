...
function hc_render_7_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-7-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/7-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-7-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/7-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-7">
        <h3>7. Ev (İlişkiler ve Ortaklıklar) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h7-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h7-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h7-time">Doğum Saati:</label>
            <input type="time" id="hc-h7-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h7-city">Şehir:</label>
            <select id="hc-h7-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse7Hesapla()">7. Evi Hesapla</button>
        <div class="hc-result" id="hc-7-ev-hesaplama-result">
            <div class="hc-result-label">7. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h7-val">-</div>
            <div id="hc-res-h7-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
