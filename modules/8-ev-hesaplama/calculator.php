...
function hc_render_8_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-8-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/8-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-8-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/8-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-8">
        <h3>8. Ev (Dönüşüm ve Ortak Kaynaklar) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h8-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h8-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h8-time">Doğum Saati:</label>
            <input type="time" id="hc-h8-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h8-city">Şehir:</label>
            <select id="hc-h8-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse8Hesapla()">8. Evi Hesapla</button>
        <div class="hc-result" id="hc-8-ev-hesaplama-result">
            <div class="hc-result-label">8. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h8-val">-</div>
            <div id="hc-res-h8-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
