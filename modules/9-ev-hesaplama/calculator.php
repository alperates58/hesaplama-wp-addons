...
function hc_render_9_ev_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-9-ev-hesaplama',
        HC_PLUGIN_URL . 'modules/9-ev-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-9-ev-hesaplama-css',
        HC_PLUGIN_URL . 'modules/9-ev-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-house-9">
        <h3>9. Ev (Bilgelik ve Vizyon) Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-h9-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-h9-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h9-time">Doğum Saati:</label>
            <input type="time" id="hc-h9-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-h9-city">Şehir:</label>
            <select id="hc-h9-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcHouse9Hesapla()">9. Evi Hesapla</button>
        <div class="hc-result" id="hc-9-ev-hesaplama-result">
            <div class="hc-result-label">9. Ev Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-h9-val">-</div>
            <div id="hc-res-h9-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
