...
function hc_render_aile_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-aile-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/aile-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-aile-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/aile-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-aile-evi">
        <h3>Aile Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ale-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ale-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ale-time">Doğum Saati:</label>
            <input type="time" id="hc-ale-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ale-city">Şehir:</label>
            <select id="hc-ale-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcAileEviHesapla()">Aile Evini Hesapla</button>
        <div class="hc-result" id="hc-aile-evi-result">
            <div class="hc-result-label">Aile Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-ale-val">-</div>
            <div id="hc-res-ale-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
