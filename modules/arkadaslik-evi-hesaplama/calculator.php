...
function hc_render_arkadaslik_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-arkadaslik-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/arkadaslik-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-arkadaslik-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/arkadaslik-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-arkadaslik-evi">
        <h3>Arkadaşlık Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ark-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ark-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ark-time">Doğum Saati:</label>
            <input type="time" id="hc-ark-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ark-city">Şehir:</label>
            <select id="hc-ark-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcArkadaslikEviHesapla()">Arkadaşlık Evini Hesapla</button>
        <div class="hc-result" id="hc-arkadaslik-evi-result">
            <div class="hc-result-label">Arkadaşlık Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-ark-val">-</div>
            <div id="hc-res-ark-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
