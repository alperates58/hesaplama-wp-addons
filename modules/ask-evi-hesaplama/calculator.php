...
function hc_render_ask_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-ask-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/ask-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-ask-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/ask-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-ask-evi">
        <h3>Aşk Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ae-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ae-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ae-time">Doğum Saati:</label>
            <input type="time" id="hc-ae-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ae-city">Şehir:</label>
            <select id="hc-ae-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcAskEviHesapla()">Aşk Evini Hesapla</button>
        <div class="hc-result" id="hc-ask-evi-result">
            <div class="hc-result-label">Aşk Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-ae-val">-</div>
            <div id="hc-res-ae-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
