...
function hc_render_ay_burcu_hesaplama( $atts ) {
    ...
    <div class="hc-calculator" id="hc-ay-burcu-hesaplama">
        <div class="hc-header">
            <h3>Ay Burcu ve Ay Fazı Hesaplama</h3>
            <p class="hc-subtitle">Doğum anınızdaki Ay'ın burcunu, derecesini, ay fazını ve bilinçdışı duygusal ihtiyaçlarınızı keşfedin.</p>
        </div>

        <div class="hc-form-grid-3">
            <div class="hc-form-group">
                <label for="hc-ayburc-tarih">Doğum Tarihi *</label>
                <input type="date" id="hc-ayburc-tarih" value="1995-05-15">
            </div>
            <div class="hc-form-group">
                <label for="hc-ayburc-saat">Doğum Saati</label>
                <input type="time" id="hc-ayburc-saat" value="12:00">
                <div class="hc-checkbox-subtext">
                    <label>
                        <input type="checkbox" id="hc-ayburc-saat-bilinmiyor" onchange="hcAyBurcuSaatDegisti(this)"> Saati tam bilmiyorum (12:00 al)
                    </label>
                </div>
            </div>
            <div class="hc-form-group">
                <label for="hc-ayburc-sehir">Doğum Yeri (İl)</label>
                <select id="hc-ayburc-sehir">
        ...
        <button type="button" class="hc-btn" onclick="hcAyBurcuHesapla()">🌙 Ay Burcumu Hesapla</button>

        <div class="hc-result" id="hc-ay-burcu-result">
            <div class="hc-ay-summary-card">
                <div class="hc-ay-badge-row">
                    <span class="hc-ay-badge-phase" id="hc-ay-phase-badge">🌙 Ay Fazı</span>
                    <span class="hc-ay-badge-deg" id="hc-ay-deg-badge"></span>
                </div>
                <div class="hc-ay-result-title" id="hc-ayburc-value">-</div>
                <div class="hc-ay-result-subtitle" id="hc-ay-element-modality"></div>
            </div>

            <div class="hc-ay-report-card">
                <h4 class="hc-ay-report-title">✨ Ay Fazı ve Doğum Anı Enerjisi</h4>
                <div id="hc-ay-phase-desc"></div>
            </div>

            <div class="hc-ay-report-card">
                <h4 class="hc-ay-report-title">🌊 Ruhsal ve Duygusal Portre</h4>
                <div id="hc-ayburc-desc"></div>
            </div>
        </div>
    </div>
    <?php
