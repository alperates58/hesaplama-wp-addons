...
function hc_render_ay_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-ay-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/ay-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-ay-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/ay-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-ay-pos">
        <h3>Ay Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ap-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ap-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ap-time">Doğum Saati:</label>
            <input type="time" id="hc-ap-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ap-city">Şehir:</label>
            <select id="hc-ap-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcAyKonumuHesapla()">Ay Konumunu Hesapla</button>
        <div class="hc-result" id="hc-ay-pos-result">
            <div class="hc-result-label">Ay Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-ap-val">-</div>
            <div id="hc-res-ap-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
