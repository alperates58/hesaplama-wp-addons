...
function hc_render_cuma_namazi_saati_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-cuma-hesaplama',
        HC_PLUGIN_URL . 'modules/cuma-namazi-saati-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    ?>
    <div class="hc-calculator" id="hc-cuma-wrapper">
        <h3>Cuma Namazı Saati Hesaplama</h3>
        <div class="hc-form-group">
            <label>Tarih Seçin</label>
            <input type="date" id="hc-cn-date" value="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="hc-form-group">
            <label>İl Seçin (Opsiyonel)</label>
            <select id="hc-cn-city" onchange="hcCNSelectCity()">
        ...
        <div class="hc-form-group">
            ...
            <div style="display: flex; gap: 10px;">
                <input type="number" id="hc-cn-lat" placeholder="Enlem" step="0.0001">
                <input type="number" id="hc-cn-lng" placeholder="Boylam" step="0.0001">
            </div>
        </div>
        <button class="hc-btn" onclick="hcCumaHesapla()">Cuma Vaktini Hesapla</button>
        <div class="hc-result" id="hc-cn-result">
            <div class="hc-result-title">Cuma Namazı Vakti (Öğle):</div>
