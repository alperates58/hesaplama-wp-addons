...
function hc_render_dogum_haritasi_hesaplama( $atts ) {
    ...
    <div class="hc-calculator" id="hc-dogum-haritasi-hesaplama">
        <div class="hc-header">
            <h3>Ücretsiz Detaylı Doğum Haritası (Natal Çark) Hesaplama</h3>
            <p class="hc-subtitle">Güneş, Ay, Yükselen, 10 gezegen, 12 ev ve majör açılarla doğum anınızdaki gökyüzü haritanızı ve potansiyellerinizi çıkartın.</p>
        </div>

        <div class="hc-form-grid-3">
            <div class="hc-form-group">
                <label for="hc-chart-date">Doğum Tarihi *</label>
                <input type="date" id="hc-chart-date" value="1995-05-15" class="hc-input" required>
            </div>
            <div class="hc-form-group">
                <label for="hc-chart-time">Doğum Saati *</label>
                <input type="time" id="hc-chart-time" value="12:00" class="hc-input" required>
            </div>
            <div class="hc-form-group">
                <label for="hc-chart-city">Doğum Yeri (Şehir) *</label>
                <select id="hc-chart-city" class="hc-input">
                    ...
                    <option value="41.0052,28.9769" selected>İstanbul</option>
        ...
        <button type="button" class="hc-btn" onclick="hcDogumHaritasiHesapla()">✨ Doğum Haritamı Çıkar</button>

        <div class="hc-result" id="hc-chart-result">
            <!-- Big Three & Balance Summary -->
            <div class="hc-chart-hero" id="hc-chart-hero"></div>

            <!-- Planets & Points Table -->
            <div class="hc-chart-section">
                <h4 class="hc-chart-sec-title">🪐 Gezegen ve Aks Konumları (Natal Positions)</h4>
                <div class="hc-chart-planets-table" id="hc-planets-table"></div>
            </div>

            <!-- Houses Table -->
            <div class="hc-chart-section">
                <h4 class="hc-chart-sec-title">🏛️ 12 Yaşam Evi ve Ev Giriş Burçları</h4>
                <div class="hc-chart-houses-grid" id="hc-houses-grid"></div>
            </div>

            <!-- Major Aspects -->
            <div class="hc-chart-section">
                <h4 class="hc-chart-sec-title">📐 Majör Gezegensel Açılar (Aspects)</h4>
                <div class="hc-chart-aspects-list" id="hc-aspects-list"></div>
            </div>

            <!-- Psychological Summary Synthesis -->
