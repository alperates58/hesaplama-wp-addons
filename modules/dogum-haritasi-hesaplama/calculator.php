...
function hc_render_dogum_haritasi_hesaplama( $atts ) {
    ...
    <div class="hc-calculator hc-dogum-haritasi" id="hc-dogum-haritasi-hesaplama">
        ...
        <div class="hc-form-group">
            <label for="hc-dhh-il">Doğum İli</label>
            <select id="hc-dhh-il">
            ...
            <small class="hc-dogum-haritasi-not">İl seçimi il merkezinin enlem ve boylamını kullanır. Aynı il içindeki farklı ilçelerde birkaç dakikalık derece farkı oluşabilir.</small>
        </div>
        ...
        <div class="hc-form-group">
            ...
            <small class="hc-dogum-haritasi-not">Türkiye doğumları için güncel resmi saat çoğu kayıt için UTC+3 kabul edilir; eski tarihli yaz saati uygulamaları sonucu etkileyebilir.</small>
        </div>
        ...
        <div class="hc-result hc-dogum-haritasi-result" id="hc-dhh-result">
            ...
            <div class="hc-dogum-haritasi-cards" id="hc-dhh-oneri"></div>
            ...
            <div class="hc-dogum-haritasi-balance">
                <div>
                    <h4>Element Dengesi</h4>
                    <div class="hc-dogum-haritasi-details" id="hc-dhh-elementler"></div>
                </div>
                <div>
                    <h4>Nitelik Dengesi</h4>
                    <div class="hc-dogum-haritasi-details hc-dogum-haritasi-details-3" id="hc-dhh-nitelikler"></div>
                </div>
            </div>

            <div class="hc-dogum-haritasi-sections">
                <section class="hc-dogum-haritasi-section">
                    <h4>Karakter Özeti</h4>
                    <p id="hc-dhh-karakter"></p>
                </section>

                <section class="hc-dogum-haritasi-section">
                    <h4>Duygusal Dünya ve İlişkiler</h4>
                    <p id="hc-dhh-duygu"></p>
                </section>

                <section class="hc-dogum-haritasi-section">
                    <h4>Zihin, İletişim ve Hedefler</h4>
                    <p id="hc-dhh-zihin"></p>
                </section>

                <section class="hc-dogum-haritasi-section">
                    <h4>Gelişim Temaları</h4>
                    <p id="hc-dhh-gelisim"></p>
                </section>
            </div>

            <div class="hc-dogum-haritasi-section">
                <h4>Öne Çıkan Açılar</h4>
                <div class="hc-dogum-haritasi-aspects" id="hc-dhh-acilar"></div>
            </div>
