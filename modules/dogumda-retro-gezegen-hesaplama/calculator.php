...
function hc_render_dogumda_retro_gezegen_hesaplama( $atts ) {
    ...
    <div class="hc-calculator" id="hc-birth-retro">
        <h3>Doğumda Retro Gezegen Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-br-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-br-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-br-time">Doğum Saati:</label>
            <input type="time" id="hc-br-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-br-city">Şehir:</label>
            <select id="hc-br-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcDogumdaRetroHesapla()">Doğum Haritanda Retroları Bul</button>
        <div class="hc-result" id="hc-birth-retro-result">
            <div id="hc-br-summary" class="hc-br-summary"></div>
            <div id="hc-br-details" class="hc-br-details">
