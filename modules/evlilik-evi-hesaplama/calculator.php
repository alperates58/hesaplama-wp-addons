...
function hc_render_evlilik_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-evlilik-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/evlilik-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-evlilik-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/evlilik-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-evlilik-evi">
        <h3>Evlilik Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ee-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ee-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ee-time">Doğum Saati:</label>
            <input type="time" id="hc-ee-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ee-city">Şehir:</label>
            <select id="hc-ee-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcEvlilikEviHesapla()">Evlilik Evini Hesapla</button>
        <div class="hc-result" id="hc-evlilik-evi-result">
            <div class="hc-result-label">Evlilik Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-ee-val">-</div>
            <div id="hc-res-ee-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
