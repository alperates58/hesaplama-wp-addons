...
function hc_render_gezegen_burcu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-gezegen-burcu-hesaplama',
        HC_PLUGIN_URL . 'modules/gezegen-burcu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-gezegen-burcu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/gezegen-burcu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-planet-signs">
        <div class="hc-header">
            <h3>Tüm Gezegen Burçları ve Doğum Konumları Hesaplama</h3>
            <p class="hc-subtitle">Güneş, Ay, Yükselen ve tüm gezegenlerinizin (Merkür, Venüs, Mars, Jüpiter, Satürn, Uranüs, Neptün, Plüton, KAD) burç, derece ve retro durumlarını tek ekranda hesaplayın.</p>
        </div>

        <div class="hc-form-grid-3">
            <div class="hc-form-group">
                <label for="hc-ps-birth">Doğum Tarihi *</label>
                <input type="date" id="hc-ps-birth" value="1995-05-15" class="hc-input" required>
            </div>
            <div class="hc-form-group">
                <label for="hc-ps-time">Doğum Saati</label>
                <input type="time" id="hc-ps-time" value="12:00" class="hc-input">
            </div>
            <div class="hc-form-group">
                <label for="hc-ps-city">Doğum Yeri (Şehir)</label>
                <select id="hc-ps-city" class="hc-input">
        ...
        <button type="button" class="hc-btn" onclick="hcGezegenBurcuHesapla()">🪐 Tüm Gezegen Burçlarımı Hesapla</button>

        <div class="hc-result" id="hc-planet-signs-result">
            <div class="hc-ps-balance-card" id="hc-ps-balance-card">
                <!-- Element & Nitelik dengesi buraya -->
            </div>

            <div class="hc-ps-grid" id="hc-ps-grid">
                <!-- Gezegen kartları buraya -->
            </div>
        </div>
    </div>
    <?php
