...
function hc_render_gezegen_burcu_hesaplama( $atts ) {
    ...
    <div class="hc-calculator" id="hc-planet-signs">
        <h3>Gezegen Burcu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ps-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ps-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ps-time">Doğum Saati:</label>
            <input type="time" id="hc-ps-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ps-city">Şehir:</label>
        ...
        <button class="hc-btn" onclick="hcGezegenBurcuHesapla()">Tüm Burçları Hesapla</button>
