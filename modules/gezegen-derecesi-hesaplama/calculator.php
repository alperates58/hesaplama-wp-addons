...
function hc_render_gezegen_derecesi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-gezegen-derecesi-hesaplama',
        HC_PLUGIN_URL . 'modules/gezegen-derecesi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-gezegen-derecesi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/gezegen-derecesi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-planet-degrees">
        <h3>Gezegen Derecesi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-pd-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-pd-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pd-time">Doğum Saati:</label>
            <input type="time" id="hc-pd-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pd-city">Şehir:</label>
            <select id="hc-pd-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcGezegenDerecesiHesapla()">Dereceleri Hesapla</button>
        <div class="hc-result" id="hc-planet-degrees-result">
            <div class="hc-pd-grid" id="hc-pd-grid">
                <!-- Sonuçlar buraya -->
            </div>
        </div>
    </div>
