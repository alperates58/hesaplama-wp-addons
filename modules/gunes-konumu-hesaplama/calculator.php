...
function hc_render_gunes_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-gunes-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/gunes-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-gunes-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/gunes-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-gunes-pos">
        <h3>Güneş Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-gp-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-gp-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-gp-time">Doğum Saati:</label>
            <input type="time" id="hc-gp-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-gp-city">Şehir:</label>
            <select id="hc-gp-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcGunesKonumuHesapla()">Güneş Konumunu Hesapla</button>
        <div class="hc-result" id="hc-gunes-pos-result">
            <div class="hc-result-label">Güneş Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-gp-val">-</div>
            <div id="hc-res-gp-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
