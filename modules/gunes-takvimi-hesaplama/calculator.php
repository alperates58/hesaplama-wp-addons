...
function hc_render_gunes_takvimi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-gunes-takvimi-hesaplama',
        HC_PLUGIN_URL . 'modules/gunes-takvimi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-gunes-takvimi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/gunes-takvimi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-sun-calendar">
        <h3>Güneş Takvimi Hesaplama</h3>
        <div class="hc-form-row" style="display:flex; gap:10px; margin-bottom:15px;">
            <div class="hc-form-group" style="flex:1;">
                <label for="hc-sc-month">Ay:</label>
                <select id="hc-sc-month" class="hc-input">
                    <?php
            ...
            <div class="hc-form-group" style="flex:1;">
                <label for="hc-sc-year">Yıl:</label>
                <input type="number" id="hc-sc-year" class="hc-input" value="<?php echo date('Y'); ?>">
            </div>
        </div>
        <div class="hc-form-group">
            <label for="hc-sc-city">Şehir:</label>
            <select id="hc-sc-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcGunesTakvimiHesapla()">Takvimi Göster</button>
        <div class="hc-result" id="hc-sun-calendar-result">
            <table class="hc-sc-table">
                <thead>
                    <tr>
                        <th>Gün</th>
                        <th>Gündoğumu</th>
