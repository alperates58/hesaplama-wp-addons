...
function hc_render_imsak_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-imsak-hesaplama',
        HC_PLUGIN_URL . 'modules/imsak-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    ?>
    <div class="hc-calculator" id="hc-imsak-wrapper">
        <h3>İmsak Hesaplama</h3>
        <div class="hc-form-group">
            <label>Tarih Seçin</label>
            <input type="date" id="hc-im-date" value="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="hc-form-group">
            <label>İl Seçin (Opsiyonel)</label>
            <select id="hc-im-city" onchange="hcIMSelectCity()">
        ...
        <div class="hc-form-group">
            ...
            <div style="display: flex; gap: 10px;">
                <input type="number" id="hc-im-lat" placeholder="Enlem" step="0.0001">
                <input type="number" id="hc-im-lng" placeholder="Boylam" step="0.0001">
            </div>
        </div>
        <button class="hc-btn" onclick="hcImsakHesapla()">İmsak Vaktini Hesapla</button>
        <div class="hc-result" id="hc-im-result">
            <div class="hc-result-title">İmsak Vakti:</div>
            <div class="hc-result-value" id="hc-im-val">-</div>
        </div>
    </div>
    <?php
}
