...
function hc_render_jupiter_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-jupiter-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/jupiter-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-jupiter-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/jupiter-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-jupiter-pos">
        <h3>Jüpiter Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-jp-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-jp-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-jp-time">Doğum Saati:</label>
            <input type="time" id="hc-jp-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-jp-city">Şehir:</label>
            <select id="hc-jp-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcJupiterKonumuHesapla()">Jüpiter Konumunu Hesapla</button>
        <div class="hc-result" id="hc-jupiter-pos-result">
            <div class="hc-result-label">Jüpiter Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-jp-val">-</div>
            <div id="hc-res-jp-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
