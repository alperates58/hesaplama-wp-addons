...
function hc_render_kariyer_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-kariyer-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/kariyer-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-kariyer-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/kariyer-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-kariyer-evi">
        <h3>Kariyer Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-ke-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-ke-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ke-time">Doğum Saati:</label>
            <input type="time" id="hc-ke-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-ke-city">Şehir:</label>
            <select id="hc-ke-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcKariyerEviHesapla()">Kariyer Evini Hesapla</button>
        <div class="hc-result" id="hc-kariyer-evi-result">
            <div class="hc-result-label">Kariyer Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-ke-val">-</div>
            <div id="hc-res-ke-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
