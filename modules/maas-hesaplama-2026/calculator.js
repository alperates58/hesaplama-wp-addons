    ...
    if (typeof window.HC !== 'undefined' && typeof window.HC.ResultEngine !== 'undefined') {
        ...
        if (summaryEl) {
            ...
            window.HC.ResultEngine.render('maas-hesaplama-2026', {
                toplamNet: hcTL(toplam.toplamNet),
                brut: hcTL(toplam.brut),
                sskIsci: hcTL(toplam.sskIsci),
                issizlikIsci: hcTL(toplam.issizlikIsci),
                gelirVergisi: hcTL(toplam.gelirVergisi),
                damgaVergisi: hcTL(toplam.damgaVergisi),
                toplamMaliyet: hcTL(toplam.toplamMaliyet),
                metadata: {
