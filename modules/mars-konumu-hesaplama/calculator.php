...
function hc_render_mars_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-mars-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/mars-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-mars-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/mars-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-mars-pos">
        <h3>Mars Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-map-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-map-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-map-time">Doğum Saati:</label>
            <input type="time" id="hc-map-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-map-city">Şehir:</label>
            <select id="hc-map-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcMarsKonumuHesapla()">Mars Konumunu Hesapla</button>
        <div class="hc-result" id="hc-mars-pos-result">
            <div class="hc-result-label">Mars Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-map-val">-</div>
            <div id="hc-res-map-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
