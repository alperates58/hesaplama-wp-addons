...
function hc_render_merkur_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-merkur-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/merkur-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-merkur-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/merkur-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-merkur-pos">
        <h3>Merkür Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-mp-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-mp-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-mp-time">Doğum Saati:</label>
            <input type="time" id="hc-mp-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-mp-city">Şehir:</label>
            <select id="hc-mp-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcMerkurKonumuHesapla()">Merkür Konumunu Hesapla</button>
        <div class="hc-result" id="hc-merkur-pos-result">
            <div class="hc-result-label">Merkür Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-mp-val">-</div>
            <div id="hc-res-mp-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
