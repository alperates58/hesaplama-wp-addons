...
function hc_render_namaz_vakitleri_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-namaz-vakitleri',
        HC_PLUGIN_URL . 'modules/namaz-vakitleri-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    ?>
    <div class="hc-calculator" id="hc-namaz-vakitleri-wrapper">
        <h3>Namaz Vakitleri Hesaplama</h3>
        <div class="hc-form-group">
            <label>Tarih Seçin</label>
            <input type="date" id="hc-nv-date" value="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="hc-form-group">
            <label>İl Seçin (Opsiyonel)</label>
            <select id="hc-nv-city" onchange="hcNVSelectCity()">
        ...
        <div class="hc-form-group">
            ...
            <div style="display: flex; gap: 10px;">
                <input type="number" id="hc-nv-lat" placeholder="Enlem" step="0.0001">
                <input type="number" id="hc-nv-lng" placeholder="Boylam" step="0.0001">
            </div>
        </div>
        <button class="hc-btn" onclick="hcNamazVakitleriHesapla()">Vakitleri Hesapla</button>
        <div class="hc-result" id="hc-nv-result">
            <table class="hc-kkao-table">
                <tr><td>İmsak (Fajr)</td><td id="hc-v-imsak">-</td></tr>
                <tr><td>Güneş (Sunrise)</td><td id="hc-v-gunes">-</td></tr>
                <tr><td>Öğle (Dhuhr)</td><td id="hc-v-ogle">-</td></tr>
                <tr><td>İkindi (Asr)</td><td id="hc-v-ikindi">-</td></tr>
                <tr><td>Akşam (Maghrib)</td><td id="hc-v-aksam">-</td></tr>
                <tr><td>Yatsı (Isha)</td><td id="hc-v-yatsi">-</td></tr>
            </table>
        </div>
    </div>
    <?php
