...
function hc_render_neptun_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-neptun-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/neptun-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-neptun-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/neptun-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-neptun-pos">
        <h3>Neptün Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-np-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-np-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-np-time">Doğum Saati:</label>
            <input type="time" id="hc-np-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-np-city">Şehir:</label>
            <select id="hc-np-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcNeptunKonumuHesapla()">Neptün Konumunu Hesapla</button>
        <div class="hc-result" id="hc-neptun-pos-result">
            <div class="hc-result-label">Neptün Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-np-val">-</div>
            <div id="hc-res-np-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
