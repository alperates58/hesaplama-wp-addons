...
function hc_render_para_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-para-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/para-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-para-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/para-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-para-evi">
        <h3>Para Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-pe-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-pe-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pe-time">Doğum Saati:</label>
            <input type="time" id="hc-pe-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pe-city">Şehir:</label>
        ...
        <button class="hc-btn" onclick="hcParaEviHesapla()">Para Evini Hesapla</button>
        <div class="hc-result" id="hc-para-evi-result">
            <div class="hc-result-label">Para Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-pe-val">-</div>
            <div id="hc-res-pe-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
