...
function hc_render_pluton_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-pluton-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/pluton-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-pluton-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/pluton-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-pluton-pos">
        <h3>Plüton Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-pp-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-pp-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pp-time">Doğum Saati:</label>
            <input type="time" id="hc-pp-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-pp-city">Şehir:</label>
            <select id="hc-pp-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcPlutonKonumuHesapla()">Plüton Konumunu Hesapla</button>
        <div class="hc-result" id="hc-pluton-pos-result">
            <div class="hc-result-label">Plüton Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-pp-val">-</div>
            <div id="hc-res-pp-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
