...
function hc_render_saglik_evi_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-saglik-evi-hesaplama',
        HC_PLUGIN_URL . 'modules/saglik-evi-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-saglik-evi-hesaplama-css',
        HC_PLUGIN_URL . 'modules/saglik-evi-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-saglik-evi">
        <h3>Sağlık Evi Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-se-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-se-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-se-time">Doğum Saati:</label>
            <input type="time" id="hc-se-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-se-city">Şehir:</label>
            <select id="hc-se-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcSaglikEviHesapla()">Sağlık Evini Hesapla</button>
        <div class="hc-result" id="hc-saglik-evi-result">
            <div class="hc-result-label">Sağlık Evi Burcunuz:</div>
            <div class="hc-result-value" id="hc-res-se-val">-</div>
            <div id="hc-res-se-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
