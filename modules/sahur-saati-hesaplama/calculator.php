...
function hc_render_sahur_saati_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-sahur-hesaplama',
        HC_PLUGIN_URL . 'modules/sahur-saati-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    ?>
    <div class="hc-calculator" id="hc-sahur-wrapper">
        <h3>Sahur Saati Hesaplama</h3>
        <div class="hc-form-group">
            <label>Tarih Seçin</label>
            <input type="date" id="hc-sh-date" value="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="hc-form-group">
            <label>İl Seçin (Opsiyonel)</label>
            <select id="hc-sh-city" onchange="hcSHSelectCity()">
        ...
        <div class="hc-form-group">
            ...
            <div style="display: flex; gap: 10px;">
                <input type="number" id="hc-sh-lat" placeholder="Enlem" step="0.0001">
                <input type="number" id="hc-sh-lng" placeholder="Boylam" step="0.0001">
            </div>
        </div>
        <button class="hc-btn" onclick="hcSahurHesapla()">Sahur Vaktini Hesapla</button>
        <div class="hc-result" id="hc-sh-result">
            <div class="hc-result-title">Sahur Bitiş (İmsak):</div>
