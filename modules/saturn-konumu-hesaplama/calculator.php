...
function hc_render_saturn_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-saturn-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/saturn-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-saturn-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/saturn-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-saturn-pos">
        <h3>Satürn Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-sap-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-sap-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-sap-time">Doğum Saati:</label>
            <input type="time" id="hc-sap-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-sap-city">Şehir:</label>
            <select id="hc-sap-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcSaturnKonumuHesapla()">Satürn Konumunu Hesapla</button>
        <div class="hc-result" id="hc-saturn-pos-result">
            <div class="hc-result-label">Satürn Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-sap-val">-</div>
            <div id="hc-res-sap-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
