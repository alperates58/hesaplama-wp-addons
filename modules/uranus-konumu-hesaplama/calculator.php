...
function hc_render_uranus_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-uranus-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/uranus-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-uranus-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/uranus-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-uranus-pos">
        <h3>Uranüs Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-up-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-up-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-up-time">Doğum Saati:</label>
            <input type="time" id="hc-up-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-up-city">Şehir:</label>
            <select id="hc-up-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcUranusKonumuHesapla()">Uranüs Konumunu Hesapla</button>
        <div class="hc-result" id="hc-uranus-pos-result">
            <div class="hc-result-label">Uranüs Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-up-val">-</div>
            <div id="hc-res-up-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
