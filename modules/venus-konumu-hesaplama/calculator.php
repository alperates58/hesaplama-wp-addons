...
function hc_render_venus_konumu_hesaplama( $atts ) {
    wp_enqueue_script(
        'hc-venus-konumu-hesaplama',
        HC_PLUGIN_URL . 'modules/venus-konumu-hesaplama/calculator.js',
        [], HC_VERSION, true
    );
    wp_enqueue_style(
        'hc-venus-konumu-hesaplama-css',
        HC_PLUGIN_URL . 'modules/venus-konumu-hesaplama/calculator.css',
        [ 'hesaplama-suite' ], HC_VERSION
    );
    ?>
    <div class="hc-calculator" id="hc-venus-pos">
        <h3>Venüs Konumu Hesaplama</h3>
        <div class="hc-form-group">
            <label for="hc-vp-birth">Doğum Tarihi:</label>
            <input type="date" id="hc-vp-birth" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-vp-time">Doğum Saati:</label>
            <input type="time" id="hc-vp-time" class="hc-input">
        </div>
        <div class="hc-form-group">
            <label for="hc-vp-city">Şehir:</label>
            <select id="hc-vp-city" class="hc-input">
        ...
        <button class="hc-btn" onclick="hcVenusKonumuHesapla()">Venüs Konumunu Hesapla</button>
        <div class="hc-result" id="hc-venus-pos-result">
            <div class="hc-result-label">Venüs Burcunuz ve Konumu:</div>
            <div class="hc-result-value" id="hc-res-vp-val">-</div>
            <div id="hc-res-vp-desc" class="hc-res-desc"></div>
        </div>
    </div>
    <?php
}
