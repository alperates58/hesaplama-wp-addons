...
function hc_render_yukselen_burc_hesaplama( $atts ) {
    ...
    <div class="hc-calculator" id="hc-yukselen-burc-hesaplama">
        <div class="hc-header">
            <h3>Yükselen ve Alçalan Burç Hesaplama</h3>
            <p class="hc-subtitle">Doğum anınızdaki doğu ufku çizgisini (Yükselen/ASC), fiziksel auranızı ve ideal partner burcunuzu (Alçalan/DSC) keşfedin.</p>
        </div>

        <div class="hc-form-grid-3">
            <div class="hc-form-group">
                <label for="hc-asc-tarih">Doğum Tarihi *</label>
                <input type="date" id="hc-asc-tarih" value="1995-05-15" class="hc-input" required>
            </div>
            <div class="hc-form-group">
                <label for="hc-asc-saat">Doğum Saati *</label>
                <input type="time" id="hc-asc-saat" value="08:30" class="hc-input" required>
                <div class="hc-asc-note">Yükselen burç her 2 saatte bir değiştiği için doğum saati çok önemlidir.</div>
            </div>
            <div class="hc-form-group">
                <label for="hc-asc-sehir">Doğum Yeri (İl) *</label>
                <select id="hc-asc-sehir" class="hc-input">
        ...
        <button type="button" class="hc-btn" onclick="hcYukselenBurcHesapla()">⬆ Yükselen Burcumu Hesapla</button>

        <div class="hc-result" id="hc-yukselen-burc-result">
            <div class="hc-asc-summary-card">
                <div class="hc-asc-badge-row">
                    <span class="hc-asc-badge-deg" id="hc-asc-deg-badge">-</span>
                    <span class="hc-asc-badge-dsc" id="hc-dsc-badge">-</span>
                </div>
                <div class="hc-asc-result-title" id="hc-asc-value">-</div>
                <div class="hc-asc-result-subtitle" id="hc-asc-meta">-</div>
            </div>

            <div class="hc-asc-report-card">
                <h4 class="hc-asc-report-title">🎭 Dış Dünya Maskeniz & İlk İzleniminiz</h4>
                <div id="hc-asc-desc"></div>
            </div>

            <div class="hc-asc-report-card">
                <h4 class="hc-asc-report-title">💍 Alçalan Burç (DSC) ve İdeal Eş / Partner Temanız</h4>
                <div id="hc-dsc-desc"></div>
            </div>
        </div>
    </div>
    <?php
